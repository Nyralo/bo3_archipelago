...
{
	level endon( "ap_Pack_A_Punch_off" );
	level waittill( "ap_Pack_A_Punch_on" );
...
{
	level waittill( "ap_Pack_A_Punch_off" );
...
{
	self endon("death");
	self endon("ap_Pack_A_Punch_off");
...
function private vending_weapon_upgrade()
{
	...
	//
	self SetHintString( "PAP Item Not Collected" );
	...
	//self thread zm_magicbox::decide_hide_show_hint("ap_Pack_A_Punch_off");
...
function private turn_off( origin, radius )
{
	...
	level notify( "ap_Pack_A_Punch_off" );
